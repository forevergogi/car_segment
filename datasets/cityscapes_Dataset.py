...
class City_Dataset(data.Dataset):
    def __init__(self,
        ...
        if aug:
            self.list_path = os.path.join(list_path, "datasets/city_list_aug")
        else:
        ...
        self.gt_filepath = os.path.join(self.data_path, "3classesMask")
    ...
    def __getitem__(self, item):
        ...
        gt_filename = filename + "_gtFine_labelTrainIds.png"
